...
do
    ...
    do
        ...
        python3 -c 'from image_analysis import get_gram_matrix_discrim; get_gram_matrix_discrim.compute_discrim_ecoset_allbasic("'${image_set_name}'","'${layer_process}'", '${debug}', '${n_per_categ}', '${n_cv}')'
