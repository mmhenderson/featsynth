...
image_set_name=images_expt1_withscrambled

# python3 -c 'from code_imageanalysis import prep_images; prep_images.prep()'
...
# python3 -c 'from code_imageanalysis import get_features; get_features.get_resnet_features_TEST('${debug}', "'${training_type}'", "'${image_set_name}'")'