...
def prep(grayscale = False, lowpass_sigma=0, highpass_sigma=0, intact_only=False):
    
    grayscale = grayscale==1
    intact_only = intact_only==1
    
    if grayscale:
        # expt 2 are grayscale images
        expt_name = 'expt2'
        image_set_name = 'images_expt2'
        stims_root = '/user_data/mmhender/stimuli/featsynth/images_v1_grayscale'
    
    elif (lowpass_sigma==0) and (highpass_sigma==0):
        # expt 1 are colored images
        expt_name = 'expt1'
    ...
    elif lowpass_sigma>0:
        expt_name = 'expt1'
        image_set_name = 'images_expt1_filt_lowpass_sigma%d'%lowpass_sigma
        stims_root = '/user_data/mmhender/stimuli/featsynth/images_v1_filtered/filt_lowpass_sigma%d'%lowpass_sigma
        
    elif highpass_sigma>0:
        expt_name = 'expt1'
        image_set_name = 'images_expt1_filt_highpass_sigma%d'%highpass_sigma
        stims_root = '/user_data/mmhender/stimuli/featsynth/images_v1_filtered/filt_highpass_sigma%d'%highpass_sigma
