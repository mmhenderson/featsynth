...
def save_categ_info():
    ...
    save_filename = os.path.join(project_root, 'code', 'make_expt_designs', 'expt2_categ_info.npy')
...
def choose_category_subsets():
    ...
    # use the behavioral performance on each supercategory in expt2 
    ...
    Note these are chosen based on behavioral performance for expt2 subjects
